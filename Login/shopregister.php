               ...
               <div class="box2">
                  <form action="../login/shopregister.php" method="post" id="loginForm">
                     ...
                     <div class="txt_field mb-3">
                        ...
                        <input type="text" name="sname" placeholder="Shop Name" class="form-control"
                           id="exampleInputName" aria-describedby="emailHelp">
                     </div>
                     <div class="txt_field mb-3">
                        <label for="exampleInputEmail1" class="form-label">GSTIN</label>
                        <input type="alphanumeric" name="gstin" placeholder="GSTIN" class="form-control"
                           id="exampleInputName" aria-describedby="emailHelp">
                     </div>
                     <div class="txt_field mb-3">
                     ...
                     <div class="txt_field mb-3">
                        ...
                        <input type="text" name="state" placeholder="State" class="form-control" id="exampleInputName"
                           aria-describedby="emailHelp">
                     </div>
                     <div class="txt_field mb-3">
                        <label for="exampleInputEmail1" class="form-label">City</label>
                        <input type="text" name="city" placeholder="City" class="form-control" id="exampleInputName"
                           aria-describedby="emailHelp">
                     </div>
                     <div class="txt_field mb-3">
                        <label for="exampleInputEmail1" class="form-label">Pincode</label>
                        <input type="numeric" name="pincode" placeholder="Pincode" class="form-control"
                           id="exampleInputName" aria-describedby="emailHelp">
                     </div>
